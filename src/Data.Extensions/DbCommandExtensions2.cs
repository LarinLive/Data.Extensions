...
/// </summary>
public static class DbCommandExtensions2
{
	/// <summary>
	...
	public static T? ExecuteScalar<T>(this DbCommand cmd) where T : class
	{
	...
	public static async Task<T?> ExecuteScalarAsync<T>(this DbCommand cmd, CancellationToken ct = default) where T : class
	{
