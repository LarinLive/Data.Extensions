...
/// </summary>
public static class DbDataReaderExtensions1
{
	/// <summary>
	...
	public static T? GetValue<T>(this DbDataReader reader, int fieldIndex) where T : struct =>
	...
	public static async Task<T?> GetValueAsync<T>(this DbDataReader reader, int fieldIndex, CancellationToken ct = default) where T : struct =>
